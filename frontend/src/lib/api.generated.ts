 ...
 *
 * TypeScript descriptions of every Django API endpoint and JSON shape, produced
 * from `backend/schema.yaml` by `./scripts/sync-api-schema.sh`.
 *
 * Pages should import domain types from `@/lib/types` instead of this file.
